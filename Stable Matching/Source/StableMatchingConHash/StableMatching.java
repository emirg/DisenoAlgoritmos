...
public class StableMatching {
    ...
    HashMap<String, ArrayList<String>> preferencias;
    HashMap<String, String> match;
    ArrayList<String> hombresLibres;
    ...
    public void readFile(String filePath) {
        ...
        try {
            ...
            while ((currentLineString = fileReader.readLine()) != null) {
                ...
                ArrayList<String> preferenciasActual = new ArrayList();
        ...
        while (!hombresLibres.isEmpty()) {
            for (int i = 0; i < hombresLibres.size(); i++) {
                ...
                if (match.get(mujer) == null) {
                    ...
                    ArrayList<String> preferenciasMujer = preferencias.get(mujer);
